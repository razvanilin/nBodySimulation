...
void ofApp::cudaSetup() {
	cudaSetDevice(0);

	cudaGetDevice(&_device);

	// Get CUDA device properties
	cudaGetDeviceProperties(&_properties, _device);

	// display properties
	cout << "Name: " << _properties.name << endl;
	cout << "CUDA Capability: " << _properties.major << " . " << _properties.minor << endl;
	cout << "Cores: " << _properties.multiProcessorCount << endl;
	cout << "Memory: " << _properties.totalGlobalMem / (1024 * 1024) << "MB" << endl;
	cout << "Clock freq: " << _properties.clockRate / 1000 << "MHz" << endl;
}
